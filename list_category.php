...
if(isset($_POST['multiple_delete']))
 ...
 if($checkbox_count <= 0)
  {
  	$_SESSION['status'] = "No Category Seleted";
  }    
 else
  {
   	   ...
   	   if(is_numeric($del_id))
   	    {
   	       ...
   	       $sql2 = "delete from category WHERE category_id='$del_id'";

           if($conn->query($sql2) === TRUE)
         	{
         		$_SESSION['status']="Category Deleted"; 
        	  //echo  '<script type="text/javascript">document.getElementById("error_msg").innerHTML = "Deleted";</script>';  
         	}
       	   else
         	{
         		$_SESSION['status']="Failed to Deleted Category";
             // echo '<script type="text/javascript">document.getElementById("error_msg").innerHTML = "Failed";</script>';
         	} 
        }
   }
  }      
		...
		<div class="filable_form_container">
			...
			<div class="table_container_block">
				<table width="100%" >
                 ...
                 <?php
		     		 $sql="SELECT * FROM category order by category_id asc LIMIT $offset,$per_page";
                    ...
                    $result = $conn->query($sql);
						...
						<tr >
							...
							<td>
								...
								<a href="delete_file_category.php?id=<?php echo $id; ?>" onclick="return confirm(' you want to delete?\n <?php echo $cname; ?>');";  style="background-color:#fc5858;padding:7px;margin:5px;" >
								    		    <span class="glyphicon glyphicon-trash" style="color:white;"></span>
                                   </a>
								  
								   <a href="edit_category.php?id=<?php echo $id; ?>" style="background-color:#7c943b;padding:7px;" >
			...
			<div class="pagination" style="float:left;">
				<ul>
                   <li><a href="list_category.php?page_no=1">first</a></li>
				<?php
				  for($i=1;$i<=$total_pages;$i++)
				   {
				   	?>
				   	 <li><a href="list_category.php?page_no=<?php echo $i; ?>"><?php echo $i; ?></a></li>
			 <?php } ?>

     				 <li><a href="list_category.php?page_no=<?php echo $total_pages; ?>">Last</a></li>
				</ul>
			</div>
