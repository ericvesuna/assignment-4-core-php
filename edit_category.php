...
require 'db_connection.php';
  ...
  $categoryid = $_GET['id'];
  $sql_name = "Select * from category WHERE category_id = '$categoryid'";
  $result_name = $conn->query($sql_name);
  $row_name = $result_name->fetch_assoc();
  $selected_categoryname = $row_name['category_name'];
 // echo $selected_categoryname;
?>
				...
				<ul>
					<li class="fileds">
						<div class="name_fileds">
							...
							<form id="frm_add_category" action="" method="post">

							<label>Category Name<span style="color:red">*</span></label>
							<input name="add_category" id="add_category" type="text" value="<?php echo $selected_categoryname; ?>"> 
 ...
 if(isset($_POST['submit']))
  {
   ...
   if($categoryname == "")
    {
    	echo '<script type="text/javascript">document.getElementById("error_msg").innerHTML = "Please Enter Category Name";</script>'; 
    }
   else
   {


 	$sql="Select category_name from category WHERE category_name='$categoryname' AND category_id <> '$categoryid'";
   	...
   	if($rowcount > 0)
     {
      ...
      echo '<script type="text/javascript">document.getElementById("error_msg").innerHTML = "Category alredy present";</script>'; 
     
     }

 	else
 	 { 
 		$sql1="update category SET category_name='$categoryname' WHERE category_id='$categoryid'";
