<!DOCTYPE html>
<!-- saved from url=(0076)http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html -->
...
<link href="./listproduct_files/default.css" rel="stylesheet" type="text/css" media="all">
<link href="./listproduct_files/stylesheet.css" rel="stylesheet" type="text/css" media="all">
...
<script src="./listproduct_files/jquery.min.js"></script>
<!-- bxSlider Javascript file -->
<script src="./listproduct_files/jquery.bxslider.min.js"></script>
<script src="./listproduct_files/script.js" type="text/javascript"></script>

<!-- bxSlider CSS file -->
<link href="./listproduct_files/jquery.bxslider.css" rel="stylesheet">
<!-- Responsive -->
<link href="./listproduct_files/responsive.css" rel="stylesheet">
  ...
  <header class="clearfix">
    ...
    <div class="container"><!--container Start-->
		...
		<div class="Logo_Cont left"><!--Logo_Cont Start-->
           ...
           <a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/index.html"><img src="./listproduct_files/logo.png" alt=""></a>
				...
				<table width="100%">
					...
					<tbody>
						<tr>
							...
							<td>Iphone</td>
							<td style="text-align:center"><img src="./listproduct_files/noimage.jpg" style="width:80px; height:auto;"></td>
...
<div class="section clearfix section-colored7"><!--section start--> 
	...
	<div class="container"><!--container Start-->
		...
		<div class="Download_Cont_Top_Left left"><!--Download_Cont_Top Start-->
			<img src="./listproduct_files/icon5.png" alt=""> <h1 style="display:inline;">FREE: Men Are From Mars</h1> <a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#">Download Now</a>
  ...
  <footer class="footer_wrapper">
    ...
    <div class="container"><!--container Start-->
		...
		<div class="Footer_Cont_Top clearfix"><!--Footer_Cont_Top Start-->
			...
			<span class="left"><img src="./listproduct_files/foot_logo.png" alt=""></span>
...
Live a life without regrets and take action today!</p>
		...
		<div class="Footer_Cont_Top2 clearfix"><!--Footer_Cont_Top2 Start-->
			...
			<h1>Call Us Today! (02) 9017 8413</h1>
			 <a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#">Book an Appointment <img src="./listproduct_files/icon7.png" alt=""></a>
 			 <a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#">Contact a Consultant <img src="./listproduct_files/icon6.png" alt=""></a>
		...
		<div class="Footer_Cont_Top3 clearfix"><!--Footer_Cont_Top3 Start-->
			...
			<div class="Foot_Link1"><!--Foot_Link2 Start-->
				...
				<div class="Foot_Link3"><!--Foot_Link3 Start-->
					<ul>
						<li><a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#">How to Recover After a Bad Date</a></li>
                        <li><a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#">Review | Vital Partners Review</a></li>
                        <li><a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#">Review | Vital Partners Review</a></li>
                        <li><a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#">Review | Vital Partners Derek and Julie</a></li>
                        <li><a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#">7 Rules for a Happy Relationship | Vital Partners Dating Sydney</a></li>
					</ul>
				</div><!--Foot_Link3 End-->
				...
				<div class="Foot_Link4"><!--Foot_Link4 Start-->
					<ul>
						<li class="left">
			             ...
			             <div class="Page_Link left"><a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#">http://t.co/hGCgHEU6If</a></div>
          ...
          <div class="Foot_Link5 left"><!--Foot_Link5 Start-->
			...
			<div class="Foot_Link7 right"><!--Foot_Link7 Start-->
				...
				<ul class="social_media">
					<li><a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#" class="fb">facebook</a></li>
					<li><a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#" class="twitter">Twitter</a></li>
					<li><a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#" class="linkedin">LinkedIn</a></li>
					<li><a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#" class="you_tube">You Tube</a></li>
					<li><a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#" class="gplus">googl plus</a></li>
				</ul>
    ...
    <div class="section section-colored10"><!--section section-colored9 start--> 
        ...
        <div class="container"><!--container Start-->
			...
			<a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#">Who Designed This Site?</a> <a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/list_products.html#">Who  Built This Site?</a>
			</div><!--Foot_Link8 End-->
		</div><!--container End-->
...
<script type="text/javascript" src="./listproduct_files/jquery.js"></script>	
